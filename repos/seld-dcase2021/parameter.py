...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        # INPUT PATH
        dataset_dir = r"C:\Users\gogomk\projects\seld-lite\data",  # Base folder containing the foa_dev/mic_dev and metadata folders

        # OUTPUT PATH
        feat_label_dir=r"C:\Users\gogomk\projects\seld-lite\runs\seld_feat_label",  # Directory to dump extracted features and labels
